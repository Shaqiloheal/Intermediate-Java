...
public class SerializableFields implements Serializable {
  private String make;
  private int year;
  private static final long serialVersionUID = 1L;
  // transient keyword added to model.
  ...
  public static void main(String[] args) throws FileNotFoundException, IOException, ClassNotFoundException {
    ...
    System.out.println("Toyota (Copy) - "+ toyotaCopy); // Car model will appear as Null.
